...
public class TestSet {
    ...
    public void testSetEncoder_String() {
        ...
        Assertions.assertThat(result).isEqualTo("[\"value2\",\"value1\",\"value3\"]");
    }
    ...
    public void testSetParse_String_order() {
        ...
        Assertions.assertThat(result).hasSize(3)
                .containsSequence("value1", "value2", "value3")
                .isNotExactlyInstanceOf(HashSet.class);
    }
    ...
    public void testSetEncoder_Bean() {
        ...
        String result = JSONValue.toJSONString(data);
        Assertions.assertThat(result).isEqualTo("[{\"stringValue\":\"value3\",\"intValue\":-321},{\"stringValue\":\"value2\",\"intValue\":0},{\"stringValue\":\"value1\",\"intValue\":123}]");
    }
    ...
    public void testSetParse_Bean() {
        ...
        Assertions.assertThat(result.iterator().next()).isInstanceOf(JSONObject.class);
    }
    ...
    public void testSetParse_BeanParameterTypeReferenced() {
        ...
        Assertions.assertThat(result.iterator().next().getStringValue()).isEqualTo("value3");
    }
    ...
    public void testSetEncoder_BeanWithSet() {
        ...
        String result = JSONValue.toJSONString(data);
        Assertions.assertThat(result).isEqualTo("{\"bean1Set\":[{\"stringValue\":\"value3\",\"intValue\":-321},{\"stringValue\":\"value2\",\"intValue\":0},{\"stringValue\":\"value1\",\"intValue\":123}]}");
    }
    ...
    public void testSetParse_BeanWithSet() {
        ...
        Assertions.assertThat(bean6.getBean1Set()).hasSize(3);
        Bean1 bean1 = bean6.getBean1Set().iterator().next();
        Assertions.assertThat(bean1).isInstanceOf(Bean1.class);
        Assertions.assertThat(bean1.getStringValue()).isEqualTo("value3");
    }
