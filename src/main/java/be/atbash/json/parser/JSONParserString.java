...
import static be.atbash.json.parser.ParseException.ERROR_UNEXPECTED_EOF;
...
class JSONParserString extends JSONParserMemory {
    ...
    public Object parse(String in) {
        return parse(in, DefaultJSONEncoder.getInstance());
    }
    ...
    public <T> T parse(String in, JSONEncoder<T> jsonEncoder) {
        this.base = jsonEncoder.getJSONReader();
        this.in = in;
        this.len = in.length();
